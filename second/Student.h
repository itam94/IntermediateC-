...
class Student{
    ...
    public:
        Student(){}
        Student(string firstName, string lastName, int age, string address, string phone,string city):_lastname(lastName),_firstname(firstName), _age(age),  _address(address), _phone(phone), _city(city){}
        ~Student(){}
        //getters
